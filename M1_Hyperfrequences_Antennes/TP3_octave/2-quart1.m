...
trans.L = 18.0658;		%%mres/50
trans.W = 0.265953;		%%sres/20
...
disp(['↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓']);
disp( ['->    radiated power: Prad = ' num2str(abs(nf2ff.Prad)) ' Watt']);
disp( ['->    directivity: Dmax = ' num2str(abs(nf2ff.Dmax)) ' (' num2str(10*log10(abs(nf2ff.Dmax))) ' dBi)']);
disp( ['->    efficiency: nu_rad = ' num2str(100*abs(nf2ff.Prad)./real(P_in(f_res_ind))) ' %']);
