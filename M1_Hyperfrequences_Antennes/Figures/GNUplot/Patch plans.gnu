set terminal svg
set output '~/Documents/ESTEI/M1/Hyperfréquences/TP3/Rapport/Figures/GNUplot/sch_patch_plans.svg'
...
#splot a(z)
#splot f(x)
set object 1 polygon from -1.5,-1.5,0 to -1.5,1.5,0 to 1.5,1.5,0 to 1.5,-1.5,0 fc rgb "orange" fillstyle solid 1.0 border lt -1
...
set object 2 polygon from -2,0,-20 to -2,0,20 to 2,0,20 to 2,0,-20
...
splot [t=0:30] [z=0:40] 0, cos(t), 2*t
